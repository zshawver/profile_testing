...
plf_predictions_df = create_weights(chisq_df, .39)

plf_predictions_df.to_excel(os.path.join(script_dir, "Output", "Zest_weighted_PLF_predictions_bayesianonly_fakebaseline.xlsx"), index=False)
